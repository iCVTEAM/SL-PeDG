...
# If use instance normalization after residual addition in a block
_C.MODEL.BACKBONE.WITH_IFN = False
...
_C.MODEL.LOSSES.CE.TKEPS = 0.5
_C.MODEL.LOSSES.CE.TOPK = 5
_C.MODEL.LOSSES.CE.TOPK_SCALE = 1.0
...
# -----------------------------------------------------------------------------
_C.DATASETS = CN()
# The root directory of datasets
_C.DATASETS.ROOT = "datasets"
# List of the dataset names for training
_C.DATASETS.NAMES = ("Market1501",)
_C.DATASETS.VALS = ("Market1501",)
...
_C.DATASETS.SORTED_ID = True
_C.DATASETS.SPLIT_VAL = False
_C.DATASETS.VAL_PIDS = 50
_C.DATASETS.REWRITE_JSON = False
...
_C.DATALOADER.NUM_INSTANCES_PER_CAM = 1

# Domain generalization
_C.DATALOADER.NUM_DOMAIN = 5
_C.DATALOADER.DOMAIN_SHUFFLE = False
_C.DATALOADER.NUM_SRC_DOMAINS = 3
_C.DATALOADER.NUM_TRG_DOMAINS = 1
_C.DATALOADER.MIN_SUBSET_LEN = 0
_C.DATALOADER.DOMAIN_STEP = 0
_C.DATALOADER.STEP_ITERS = 1
_C.DATALOADER.DATASET_LEN = 0
...
_C.SOLVER.HEADS_FC_LR_FACTOR = 1.
...
# Dropout SGD
_C.SOLVER.DROPOUTSGD = CN()
_C.SOLVER.DROPOUTSGD.HOOK = False
_C.SOLVER.DROPOUTSGD.LAYER_NAMES = [['backbone.conv1', 'backbone.bn1'], ['backbone.layer1',], ['backbone.layer2',],
                                    ['backbone.layer3',], ['backbone.layer4',], ['heads',]]
_C.SOLVER.DROPOUTSGD.INV_EX = False
_C.SOLVER.DROPOUTSGD.P_PROB = 0.5
_C.SOLVER.DROPOUTSGD.UPDATE_EPOCHS = 10
_C.SOLVER.DROPOUTSGD.BEGIN_LAYER = 0
_C.SOLVER.DROPOUTSGD.END_LAYER = 6
_C.SOLVER.DROPOUTSGD.STEP = 1
_C.SOLVER.DROPOUTSGD.WINDOW_SIZE = 2
_C.SOLVER.DROPOUTSGD.OPEN_ITERS = 1000
_C.SOLVER.DROPOUTSGD.DROPOUT_ALL_EPOCH = -1
_C.SOLVER.DROPOUTSGD.END_ALL_EPOCHS = -1
_C.SOLVER.DROPOUTSGD.P_PROB_LIST = []
_C.SOLVER.DROPOUTSGD.P_PROB_STEPS = []
...
_C.SOLVER.FDA_ITERS = 1
_C.SOLVER.KEEP_FDA_SRC = True
...
# T-SNE
_C.TEST.STORE_FEAT = False
_C.TEST.DO_ONCE = False
_C.TEST.STORE_FEAT_FILE = ""

# Metric of cuhk03
_C.TEST.USE_METRIC_CUHK03 = False
