...
class AdaBatchNorm1d(nn.BatchNorm1d):
    def __init__(self, num_features, eps=1e-05, momentum=None, weight_freeze=False, bias_freeze=False, weight_init=1.0,
                 bias_init=0.0):
        super(AdaBatchNorm1d, self).__init__(num_features, eps=eps, momentum=momentum)
