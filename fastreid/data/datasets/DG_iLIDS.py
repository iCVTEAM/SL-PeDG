...
class DG_ILIDS(ImageDataset):
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        rw_json = cfg.DATASETS.REWRITE_JSON
    ...
    def prepare_split(self, rw_json=False):
        if not os.path.exists(self.split_path) or rw_json:
