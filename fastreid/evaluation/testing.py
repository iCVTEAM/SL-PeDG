...
def print_csv_format(results):
    ...
    first_dataset_name = list(results.keys())[0]
    metrics = ["Datasets"] + [k for k in results[first_dataset_name]]

    csv_results = [(dataset_name, *list(res.values())) for dataset_name, res in results.items()]
